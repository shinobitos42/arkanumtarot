        ...
        <div style={styles.heroContainer}>
          ...
          <div style={styles.textContent}>
            ...
            <h1 style={styles.heroTitle}>
              Encontre a <span style={styles.italicGold}>paz</span> que o seu coração procura <span style={styles.italicGold}>através do tarot.</span>
            </h1>
...
const styles = {
  ...
  heroSection: { 
    padding: "80px 5% 80px",   /* reduzido de 120px pois a Navbar agora ocupa o topo */
    display: "flex", 
