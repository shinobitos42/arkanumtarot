...
export default function FinancasTarologo({ estatisticas }) {
  ...
  const handleSolicitarSaque = async (e) => {
    ...
    try {
      ...
      // (Precisaremos criar essa rota no Django no próximo passo)
              ...
              <tbody>
                {transacoes.map((transacao) => (
                  <tr key={transacao.id} style={styles.tr}>
                    ...
                    <td style={{...styles.td, color: '#EAE0C8'}}>{transacao.descricao}</td>
...
const styles = {
  ...
  historyCard: { backgroundColor: "#151312", border: "1px solid #2A2420", borderRadius: "12px", padding: "32px" },
  sectionTitle: { color: "#FDFBF7", fontSize: "20px", fontFamily: "'Playfair Display', serif", marginBottom: "24px" },
  tableContainer: { overflowX: "auto" },
  table: { width: "100%", borderCollapse: "collapse", textAlign: "left" },
  th: { padding: "16px", color: "#A89C92", fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "600", borderBottom: "1px solid #2A2420" },
  tr: { borderBottom: "1px solid #2A2420", transition: "backgroundColor 0.2s", '&:hover': { backgroundColor: "#1A1715" } },
  td: { padding: "16px", color: "#786C63", fontSize: "14px" },
  ...
  modalOverlay: { position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(17, 15, 14, 0.8)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 999, backdropFilter: "blur(4px)" },
  modalContent: { backgroundColor: "#1A1715", border: "1px solid #3A322C", borderRadius: "12px", padding: "32px", width: "100%", maxWidth: "450px", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" },
  ...
  inputForm: { backgroundColor: "#110F0E", border: "1px solid #3A322C", color: "#EAE0C8", padding: "14px", borderRadius: "8px", outline: "none", fontSize: "14px" },
  infoText: { color: "#D4AF37", fontSize: "11px", alignSelf: "flex-end" },
  
  btnConfirmarSaque: { padding: "16px", backgroundColor: "#D4AF37", color: "#151312", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "700", textTransform: "uppercase", cursor: "pointer", marginTop: "8px" }
};